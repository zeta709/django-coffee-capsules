...
class PurchaseItemInline_0(admin.TabularInline):
	def has_add_permission(self, request, obj=None):
		return False
	fields = ('capsule', 'price', 'quantity_accepted', 'quantity_grouped', 'quantity_queued')
	readonly_fields = ('purchase', 'capsule', 'quantity_accepted', 'quantity_grouped', 'quantity_queued')
	model = PurchaseItem
	extra = 0
...
class PurchaseItemAdmin(MyAdmin):
	readonly_fields = ('quantity_accepted', 'quantity_grouped', 'quantity_queued')
...
class RequestAdmin(MyNoDeleteAdmin):
	...
	list_display = ('purchaseitem', 'user', 'quantity_accepted', 'quantity_grouped', 'quantity_queued', 'date', )
